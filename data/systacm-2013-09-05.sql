...
(21, 4, 'email_host', '邮件服务器', 'smtp.google.com', 'string', ''),
...
CREATE TABLE IF NOT EXISTS `syst_guestbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动编码',
  `pid` int(11) NOT NULL COMMENT '留言类别',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='留言信息表' AUTO_INCREMENT=10 ;

--
-- 转存表中的数据 `syst_guestbook`
--

INSERT INTO `syst_guestbook` (`id`, `pid`, `title`, `content`, `uname`, `uemail`, `uphone`, `ucompany`, `disabled`, `add_time`) VALUES
(1, 1, '大口_VS_紫月 kof98拳皇 GGPO对战 2时10分19秒，视频由电玩街制作.', '您的需求信息是天空战队的嘛，我和他马甲玩过，EZ上有个山河碎，不过现在很少见了。 //@游戏hold:我其实一直都想知道这个紫月是谁，很早以前看视频就看到过他，可后来就再没见到过了，估计都是当时在GGPO平台玩的高手，大口退出后也都陆续离开了。', 'Rodey', 'rodeyluo@gmail.com', '13723722479', 'SYSTacm', 1, 1378136209),
(2, 1, '', '感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。', 'Rodey', 'rodeyluo@gmail.com', '13723722479', 'SYSTacm', 1, 1378182819),
(3, 1, '', '也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱', '罗勇', 'rodeyluo@gmail.com', '13723722479', '盛艺设计', 1, 1378183774),
(4, 1, '', '东风公司更好地恢复价格将会加快构建快好了后路iuop的分公司的敢死队风格三个三个三个死光光地方规划法规', '阿斯顿法', 'rodeyluo@gmail.com', '23123412341234', '使得公司的', 1, 1378183816),
(7, 1, '', 'fasdfasdfa', 'sdfas', 'rodeyluo@gmail.com', 'dfasdfa', 'asdfasd', 1, 1378193883),
(8, 1, '', 'asdfasdfasdf', 'asdfasd', 'rodeyluo@gmail.com', 'fasfdasdf', 'asdfasdf', 0, 1378383467),
(9, 1, '', '感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。', 'asdfasdf', 'rodeyluo@gmail.com', 'asdfasf', 'asdfasdf', 1, 1378193945);
...
CREATE TABLE IF NOT EXISTS `syst_log` (
  ...
  `add_time` int(20) unsigned NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统日志信息表' AUTO_INCREMENT=52 ;
...
(2, 'rodey', '5aa26937a3b0a86999868d8b28508aee', 'rodeyluo@gmail.com', '天蝎飞碟', '罗勇', 1, 1361980800, '深圳市罗湖区泥岗西村', '13723722479', '0755-21671712', '来自江西吉安盘谷镇坛山园村5566', '像风一样自由！', 'uploadfile/users/headport/100/user_13724352004357.png', 5, 1218, '1552.00', 0, '0', '127.0.0.1', 4, 1, 1362044903, 1378381738, '127.0.0.1', 1378381738),
...
(14, 'rodey2', '828972916', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
