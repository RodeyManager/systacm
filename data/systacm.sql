...
-- 数据库: `systacm`
--
CREATE DATABASE IF NOT EXISTS `systacm` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `systacm`;
...
(17, 3, 'Roadey', 'http://systacm.com/uploadfile/slider/1365436800/banner_13654368007084.gif', 980, 200, 'http://systacm.com', 0, 1, 'rodey', 1365475572, 1387986900, 1378396736);
...
(1, '关于我们', 'about', 0, 10, 10, '关于我们的企业，企业简介', '', '', 980, 200, '0', '0', '0', 1, 'rodey', 1, 0, '', '', '', '', 0, 0, 1372605413, 1372605413),
(2, '产品展示', 'prodruct', 0, 3, 0, '我们的产品，一切以客户为中心，保证质量和服务一体化！', '', '', 980, 200, '0', '0', '0', 2, 'rodey', 1, 0, '', '', '', '', 0, 0, 1372605735, 1372605735),
(3, '新闻中心', 'news', 0, 1, 0, '每天都有我们的消息，我们每天都会有新的动态，请关注我们！', '', '', 980, 200, '0', '0', '0', 3, 'rodey', 1, 0, '', '', '', '', 0, 0, 1372605501, 1372605501),
(4, '服务支持', 'support', 0, 10, 0, '我们会用心服务，做到真正的为客服着想!', '', '', 980, 200, '0', '0', '0', 4, 'rodey', 1, 0, '', '', '', '', 0, 0, 1372605700, 1372605700),
(5, '联系我们', 'contacUS', 0, 10, 0, '联系我们，联系方式：email->rodeyluo@gmail.com', '', '', 980, 200, '0', '0', '0', 5, 'rodey', 1, 0, '', '', '', '', 0, 0, 1372605595, 1372605595),
(6, '服务条款', 'service', 0, 10, 0, '', '', '', 980, 200, '0', '0', '0', 0, 'rodey', 0, 0, '', '', '', '', 0, 0, 1372605665, 1372605665),
(14, '企业文化', 'enstrpires', 0, 10, 0, '企业文化企业文化企业文化', '<p>企业文化企业文化企业文化企业文化企业文化</p><p>企业文化企业文化企业文化</p><p>企业文化企业文化企业文化</p><p>企业文化企业文化</p><p>企业文化</p>', 'uploadfile/cat/banner/banner_13637952001545.jpg', 980, 300, '0', '0', '0', 0, 'rodey', 1, 0, '企业文化', '企业文化', '企业文化', '', 1, 20, 1372605640, 1372605640),
(16, '手机', 'mobile', 2, 3, 2, '', '', '', 980, 200, '0', '0', '0', 0, 'rodey', 1, 0, '手机', '手机', '手机', '', 1, 20, 1372605768, 1372605768),
(17, 'HTC', 'HTC', 16, 3, 0, '', '', 'uploadfile/cat/banner/catbanner.gif', 980, 300, '0', '0', '0', 0, 'rodey', 1, 0, '', '', '', '', 1, 0, 1372610403, 1372610403),
(18, '公司动态', 'ComNews', 3, 1, 0, '', '', '', 0, 0, '', '', '', 0, 'rodey', 1, 0, '', '', '', '', 1, 0, 1372604103, 1372604103);
...
CREATE TABLE IF NOT EXISTS `syst_catmodel` (
  ...
  `update_time` int(30) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='数据模型信息表' AUTO_INCREMENT=12 ;
...
(10, '单页模型', 'page', '单独页面模型，如公司简介，关于我们等', 1372604612, 1372604612),
(11, '专题模型', 'special', '用于显示专题的页面模型', 1372604680, 1372604680);
...
CREATE TABLE IF NOT EXISTS `syst_config` (
  ...
  `group_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否为自定义',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统配置项信息表' AUTO_INCREMENT=67 ;

--
-- 转存表中的数据 `syst_config`
--

INSERT INTO `syst_config` (`id`, `group_id`, `group_type`, `var_name`, `var_info`, `var_value`, `var_type`, `var_rmark`) VALUES
(1, 1, 0, 'site_url', '网站地址', 'http://systacm.com', 'string', '尾部不带''/'''),
(2, 1, 0, 'site_name', '网站名称', '盛艺设计工作室', 'string', ''),
(3, 1, 0, 'html_path', '文档HTML默认保存路径', '/html', 'string', ''),
(4, 1, 0, 'upload_path', '图片/上传文件默认路径', '/uploadfile', 'string', ''),
(5, 1, 0, 'default_theme', '模板默认风格', 'default', 'string', ''),
(6, 1, 0, 'site_desc', '网站描述', '盛艺开发设计中心', 'bigstring', ''),
(7, 1, 0, 'site_copyright', '网站版权信息', 'Copyright 盛艺设计工作室  版权所有', 'string', ''),
(8, 1, 0, 'site_icp', '网站备案号', '粤ICP备13046563号-1', 'string', ''),
(9, 1, 0, 'site_time', '服务器时区设置', '8', 'int', ''),
(10, 1, 0, 'database_type', '数据库类型', 'mysql', 'string', ''),
(11, 1, 0, 'page_size', '默认分页大小', '12', 'int', ''),
(12, 3, 0, 'upload_imgtype', '允许上传的图片类型', 'jpg|gif|png', 'string', ''),
(13, 3, 0, 'upload_softtype', '允许上传的软件类型', 'zip|gz|rar|iso|doc|xsl|ppt|wps', 'string', ''),
(14, 3, 0, 'upload_mediatype', '允许上传的视频类型', 'swf|mpg|mp3|rm|rmvb|wmv|wma|wav|mid|mov', 'string', ''),
(15, 3, 0, 'user_headport_size', '会员上传头像大小限制(单位：KB)', '50', 'int', ''),
(16, 1, 0, 'cookie_code', 'cookie加密码', 'SDF90EF3OSDF', 'string', ''),
(17, 1, 0, 'admin_email', '管理员邮箱', 'rodeyluo@gmail.com', 'string', ''),
(18, 2, 0, 'water_masker_path', '水印文件地址', '/uploadfile/water_masker.png', 'string', ''),
(19, 2, 0, 'water_masker_size', '水印文件大小', '100,50', 'string', '格式：宽度,高度'),
(20, 2, 0, 'water_masker_pos', '水印位置', '3', 'int', '1：左上；2：右上；3：右下；4：左下；5：上中；6：右中；7：下中；8：左中；9：正中'),
(21, 4, 0, 'email_host', '邮件服务器', 'smtp.szhff.com', 'string', ''),
(22, 4, 0, 'email_port', '邮件发送端口', '25', 'string', ''),
(23, 4, 0, 'email_from_addr', '发件人邮箱', 'info@szhff.com', 'string', '发件人邮箱地址'),
(24, 4, 0, 'email_from_pass', '发送人密码', 'huafeng082500', 'string', '发送人邮箱密码'),
(25, 4, 0, 'email_from_name', '发送人名称', '盛艺SYSTacm', 'string', ''),
(26, 4, 0, 'email_is_authlogin', '是否开启AUTH LOGIN验证', '1', 'bool', ''),
(31, 6, 0, 'mb_open', '是否开启会员功能', '1', 'bool', ''),
(32, 6, 0, 'mb_namin', '用户账号最小长度', '3', 'int', ''),
(33, 6, 0, 'mb_pwmin', '用户密码最小长度', '6', 'int', ''),
(34, 6, 0, 'mb_spacesta', '会员使用权限开通状态', '0', 'int', '1 邮件验证 2 手工审核, 0 没限制'),
(35, 6, 0, 'mb_mail_require', '是否限制Email只能注册一个帐号', '1', 'string', '1:是;0:否'),
(36, 6, 0, 'mb_reginfo', '注册是否需要完成详细资料的填写', '1', 'string', '1:是;0:否'),
(37, 6, 0, 'mb_notallow', '不允许注册的会员账号名称', 'www,bbs,ftp,mail,user,users,admin,administrator', 'bigstring', ''),
(38, 1, 0, 'site_lang', '网站语种', 'cn', 'string', ''),
(39, 8, 0, 'is_log', '是否启用后台管理操作日志', '1', 'bool', '1:开启;0:关闭'),
(40, 8, 0, 'log_path', '保存错误日志', '/data/logs', 'string', ''),
(41, 8, 0, 'log_warm_size', '错误日志预警大小', '20', 'int', '单位( M )'),
(42, 8, 0, 'admin_login_num', '后台最大登陆失败次数', '5', 'int', '防止攻击登录，限制重试登录次数'),
(43, 8, 0, 'refresh_space', '连续两次刷新最短间隔', '2', 'int', '单位( 秒 )'),
(44, 8, 0, 'is_debug', '是否开启调试模式', '0', 'bool', '1:开启;0:关闭'),
(45, 8, 0, 'is_cache', '是否开启缓存', '1', 'bool', '1:开启;0:关闭'),
(46, 8, 0, 'chace_path', '缓存文件路径', '/temps/cache', 'string', ''),
(47, 4, 0, 'email_type', '邮件发送模式', '1', 'int', '1:SMTP 函数发送; 0:Mail模块发送'),
(51, 8, 1, 'test_string', '单行文本测试', '单行文本测试', 'string', ''),
(52, 8, 1, '多行文本测试', '多行文本测试', '多行文本测试,\n多行文本测试,\n多行文本测试', 'bigstring', '多行文本，每行以英文‘,’结尾'),
(53, 8, 1, 'test_bool', '布尔值测试', '1', 'bool', '布尔类型，真(True)/假(Flas)，变量值可以为空'),
(54, 8, 0, 'test_int', '数值测试', '10', 'int', '数值类型，变量值可以为空'),
(56, 7, 0, 'mapx', '经度值', '11395437', 'string', '定位经度值'),
(57, 7, 0, 'mapy', '纬度值', '2253923', 'string', '定位纬度值'),
(58, 7, 0, 'mapz', '比例尺级别', '1', 'string', '比例尺级别'),
(59, 7, 0, 'cfg_company', '公司名称', '盛艺设计工作室', 'string', '请填公司名称'),
(60, 7, 0, 'cfg_address', '公司地址', '深圳市南山区科技园南区德赛科技大厦10楼', 'string', '请填写公司详细地址'),
(61, 7, 0, 'cfg_website', '公司网站', 'http://www.senuu.com', 'string', '请填写公司网站，用于显示在地图上方'),
(62, 2, 0, 'water_masker_isopen', '是否开启水印', '0', 'bool', '开启水印后上传图片将打上水印图片'),
(63, 1, 0, 'catbanner_width', '栏目简介图宽度', '980', 'int', '必须为数值'),
(64, 1, 0, 'catbanner_height', '栏目简介高度', '300', 'int', '必须为数值'),
(65, 1, 1, 'cnzz_statis', 'CNZZ统计代码', '', 'bigstring', '请填入CNZZ统计代码'),
(66, 1, 1, 'baidu_statis', '百度统计代码', '', 'bigstring', '请填入百度统计代码');
...
CREATE TABLE IF NOT EXISTS `syst_flinks` (
  ...
  `add_time` int(30) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='友情连接信息表' AUTO_INCREMENT=12 ;
...
(9, '小米MIUI', 'http://www.miui.com/static/index/images/miui_logo.png', '', 'http://www.miui.com/', 1, 0, 'rodey', 1378757248),
(10, '华为', 'http://www.huawei.com/cn/ucmf/groups/public/documents/webasset/logo_cn.jpg', '', 'http://www.huawei.com', 1, 0, 'rodey', 1378757325),
(11, '微信', 'http://weixin.qq.com/zh_CN/htmledition/images/weixin/weixin_logo178fb4.png', '', 'http://weixin.qq.com/', 1, 0, 'rodey', 1378757479);
...
CREATE TABLE IF NOT EXISTS `syst_goods` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品信息表' AUTO_INCREMENT=28 ;

-- --------------------------------------------------------

--
-- 表的结构 `syst_goods_brand`
--

CREATE TABLE IF NOT EXISTS `syst_goods_brand` (
...
CREATE TABLE IF NOT EXISTS `syst_goods_cat` (
  ...
  `update_time` int(20) unsigned NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品分类信息表' AUTO_INCREMENT=22 ;

--
-- 转存表中的数据 `syst_goods_cat`
--

INSERT INTO `syst_goods_cat` (`id`, `pid`, `tid`, `cat_name`, `cat_path`, `cat_seo`, `is_leaf`, `goods_count`, `child_count`, `sort`, `disabled`, `author`, `add_time`, `update_time`) VALUES
(1, 0, 1, '手机', ',', 'a:3:{s:10:"page_title";s:6:"手机";s:13:"page_keywords";s:6:"手机";s:9:"page_desc";s:6:"手机";}', 0, 0, 0, 0, 1, 'rodey', 1367737434, 1367737434),
(2, 0, 1, '电脑', ',', 'a:3:{s:10:"page_title";s:6:"电脑";s:13:"page_keywords";s:6:"电脑";s:9:"page_desc";s:6:"电脑";}', 0, 0, 0, 0, 1, 'rodey', 1367737633, 1367737633),
(3, 1, 1, '智能手机', ',', 'a:3:{s:10:"page_title";s:12:"智能手机";s:13:"page_keywords";s:12:"智能手机";s:9:"page_desc";s:12:"智能手机";}', 0, 0, 0, 0, 1, 'rodey', 1367739773, 1367739773),
(6, 1, 1, '时尚手机', ',', 'a:3:{s:10:"page_title";s:12:"时尚手机";s:13:"page_keywords";s:12:"时尚手机";s:9:"page_desc";s:12:"时尚手机";}', 1, 0, 0, 0, 1, 'rodey', 1367746241, 1367746241),
(7, 1, 1, '双卡双待', ',', 'a:3:{s:10:"page_title";s:18:"双卡双待手机";s:13:"page_keywords";s:18:"双卡双待手机";s:9:"page_desc";s:18:"双卡双待手机";}', 1, 0, 0, 0, 1, 'rodey', 1367746958, 1367746958),
(8, 2, 1, '台式电脑', ',', 'a:3:{s:10:"page_title";s:12:"台式电脑";s:13:"page_keywords";s:12:"台式电脑";s:9:"page_desc";s:12:"台式电脑";}', 1, 0, 0, 0, 1, 'rodey', 1367747007, 1367747007),
(9, 2, 1, '液晶电脑', ',', 'a:3:{s:10:"page_title";s:12:"液晶电脑";s:13:"page_keywords";s:12:"液晶电脑";s:9:"page_desc";s:12:"液晶电脑";}', 1, 0, 0, 0, 1, 'rodey', 1367747028, 1367747028),
(10, 2, 1, '平板电脑', ',', 'a:3:{s:10:"page_title";s:12:"平板电脑";s:13:"page_keywords";s:12:"平板电脑";s:9:"page_desc";s:12:"平板电脑";}', 1, 0, 0, 0, 1, 'rodey', 1367747049, 1367747049),
(11, 2, 1, '上网本', ',', 'a:3:{s:10:"page_title";s:9:"上网本";s:13:"page_keywords";s:9:"上网本";s:9:"page_desc";s:9:"上网本";}', 1, 0, 0, 0, 1, 'rodey', 1367747067, 1367747067),
(12, 0, 1, '数码/影音', ',', 'a:3:{s:10:"page_title";s:13:"数码/影音";s:13:"page_keywords";s:13:"数码,影音";s:9:"page_desc";s:13:"数码/影音";}', 1, 0, 0, 0, 1, 'rodey', 1367760229, 1367760229),
(13, 3, 1, 'HTC', ',', 'a:3:{s:10:"page_title";s:3:"HTC";s:13:"page_keywords";s:3:"HTC";s:9:"page_desc";s:3:"HTC";}', 1, 0, 0, 0, 1, 'rodey', 1367763206, 1367763206),
(14, 3, 1, '三星(Samsung)', ',', 'a:3:{s:10:"page_title";s:15:"三星(Samsung)";s:13:"page_keywords";s:15:"三星(Samsung)";s:9:"page_desc";s:15:"三星(Samsung)";}', 1, 0, 0, 0, 1, 'rodey', 1367763300, 1367763300),
(15, 0, 1, 'GPS导航仪', ',', 'a:3:{s:10:"page_title";s:12:"GPS导航仪";s:13:"page_keywords";s:12:"GPS导航仪";s:9:"page_desc";s:12:"GPS导航仪";}', 0, 0, 0, 0, 1, 'rodey', 1368356747, 1368356747),
(16, 0, 1, '电子狗', ',', 'a:3:{s:10:"page_title";s:9:"电子狗";s:13:"page_keywords";s:9:"电子狗";s:9:"page_desc";s:9:"电子狗";}', 1, 0, 0, 0, 1, 'rodey', 1368357766, 1368357766),
(17, 0, 1, '移动电源', ',', 'a:3:{s:10:"page_title";s:12:"移动电源";s:13:"page_keywords";s:12:"移动电源";s:9:"page_desc";s:12:"移动电源";}', 1, 0, 0, 0, 1, 'rodey', 1368357789, 1368357789),
(18, 0, 1, '行车记录仪', ',', 'a:3:{s:10:"page_title";s:15:"行车记录仪";s:13:"page_keywords";s:15:"行车记录仪";s:9:"page_desc";s:15:"行车记录仪";}', 1, 0, 0, 0, 1, 'rodey', 1368357813, 1368357813),
(19, 15, 1, '5寸GPS', ',', 'a:3:{s:10:"page_title";s:7:"5寸GPS";s:13:"page_keywords";s:7:"5寸GPS";s:9:"page_desc";s:7:"5寸GPS";}', 1, 0, 0, 0, 1, 'rodey', 1368357859, 1368357859),
(20, 15, 1, '6寸GPS', ',', 'a:3:{s:10:"page_title";s:7:"6寸GPS";s:13:"page_keywords";s:7:"6寸GPS";s:9:"page_desc";s:7:"6寸GPS";}', 0, 0, 0, 0, 1, 'rodey', 1368357876, 1368357876),
(21, 15, 1, '7寸GPS', ',', 'a:3:{s:10:"page_title";s:7:"7寸GPS";s:13:"page_keywords";s:7:"7寸GPS";s:9:"page_desc";s:7:"7寸GPS";}', 1, 0, 0, 0, 1, 'rodey', 1368357897, 1368357897);

-- --------------------------------------------------------

--
-- 表的结构 `syst_goods_imgs`
--

CREATE TABLE IF NOT EXISTS `syst_goods_imgs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品图片信息表' AUTO_INCREMENT=44 ;

-- --------------------------------------------------------

--
-- 表的结构 `syst_goods_keywords`
--

CREATE TABLE IF NOT EXISTS `syst_goods_keywords` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  `name` varchar(200) NOT NULL COMMENT '名称',
  `relevan` varchar(200) NOT NULL COMMENT '关联表',
  `hrefs` longtext NOT NULL COMMENT '关联的主键列表',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品关键字信息表' AUTO_INCREMENT=28 ;

-- --------------------------------------------------------

--
-- 表的结构 `syst_goods_type`
--

CREATE TABLE IF NOT EXISTS `syst_goods_type` (
  ...
  `update_time` int(20) unsigned NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='商品类型信息表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `syst_goods_type`
--

INSERT INTO `syst_goods_type` (`id`, `name`, `spec`, `props`, `params`, `setting`, `disabled`, `author`, `add_time`, `update_time`) VALUES
(1, '通用商品类型', '', '', '', '', 1, 'rodey', 1367719040, 1367719040);
...
CREATE TABLE IF NOT EXISTS `syst_guestbook` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='留言信息表' AUTO_INCREMENT=61 ;

--
-- 转存表中的数据 `syst_guestbook`
--

INSERT INTO `syst_guestbook` (`id`, `pid`, `title`, `content`, `uname`, `uemail`, `uphone`, `ucompany`, `reply`, `disabled`, `add_time`, `update_time`) VALUES
(1, 1, '大口_VS_紫月 kof98拳皇 GGPO对战 2时10分19秒，视频由电玩街制作.', '您的需求信息是天空战队的嘛，我和他马甲玩过，EZ上有个山河碎，不过现在很少见了。 //@游戏hold:我其实一直都想知道这个紫月是谁，很早以前看视频就看到过他，可后来就再没见到过了，估计都是当时在GGPO平台玩的高手，大口退出后也都陆续离开了。', 'Rodey', 'rodeyluo@gmail.com', '13723722479', 'SYSTacm', 1, 1, 1378136209, 1378668061),
(2, 1, '', '感谢您浏览了我们的网站，如果需要更多帮助，\n欢迎向我们提交需求信息，我们也欢迎您与我们面谈。', 'Rodey', 'rodeyluo@gmail.com', '13723722479', 'SYSTacm', 0, 1, 1378182819, 0),
(3, 1, '', '也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱也可以将您的需求信息直接发送至邮箱', '罗勇', 'rodeyluo@gmail.com', '13723722479', '盛艺设计', 0, 1, 1378183774, 0),
(4, 1, '', '东风公司更好地恢复价格将会加快构建快好了后路iuop的分公司的敢死队风格三个三个三个死光光地方规划法规', '阿斯顿法', 'rodeyluo@gmail.com', '23123412341234', '使得公司的', 1, 1, 1378468584, 1378474767),
(8, 1, '', 'asdfasdfasdf', 'asdfasd', 'rodeyluo@gmail.com', 'fasfdasdf', 'asdfasdf', 0, 0, 1378463611, 0),
(19, 1, '', 'sdfasf', 'asdfas', 'rodeyluo@gmail.com', 'dfasdf', 'asdfa', 0, 1, 1378477453, 1378477453),
(20, 1, '', 'asdfasdf', 'dfasdf', 'rodeyluo@gmail.com', 'sfasdfas', 'asf', 0, 1, 1378477673, 1378477673),
(21, 1, '', 'asfasfa', 'asefa', 'rodeyluo@gmail.com', 'fa', 'fasf', 0, 1, 1378477729, 1378477729),
(22, 1, '', 'dfgsdfgsdfgsdfg', 'rodey', 'rodeyluo@gmail.com', 'agagad', 'fgdfgs', 0, 1, 1378481368, 1378481368),
(23, 1, '', 'sdfgsdfgsdf', 'sfadgsd', 'rodeyluo@gmail.com', 'sdfg', 'fgsfg', 0, 1, 1378481373, 1378481373),
(24, 1, '', 'dfghdfg', 'ergth', 'rodeyluo@gmail.com', 'hdfgh', 'dfghdfg', 0, 1, 1378481377, 1378481377),
(25, 1, '', 'fgsdfg', 'fgsdfg', 'rodeyluo@gmail.com', 'fgsd', 'sdfgsd', 0, 1, 1378481381, 1378481381),
(26, 1, '', 'fghj', 'fgfh', 'rodeyluo@gmail.com', 'fghfghfgh', 'fghj', 0, 1, 1378481386, 1378481386),
(27, 1, '', 'fgbxfgsgsd', 'kfhjfgj', 'rodeyluo@gmail.com', 'gjk,', 'kkkkkk', 0, 1, 1378481392, 1378481392),
(28, 1, '', 'etyey45yw45yw45', '56y456y', 'rodeyluo@gmail.com', 'ertye', '6ye546y', 0, 1, 1378481399, 1378481399),
(29, 1, '', 'dfafawqrq34', '4rw34sfgsrf', 'rodeyluo@gmail.com', 'erfwerferf', 'sergwertq3434', 0, 1, 1378481406, 1378481406),
(30, 1, '', 'ertwer', 'e5t345twrgw', 'rodeyluo@gmail.com', 'rgwt', 'wertw', 0, 1, 1378481411, 1378481411),
(31, 1, '', 'rgwergw', 'regsergew', 'rodeyluo@gmail.com', 'rgwe', 'rgwe', 0, 1, 1378481414, 1378481414),
(32, 1, '', 'sgssrgsdgs', 'erwergwer', 'rodeyluo@gmail.com', 'ger', 'gsdf', 0, 1, 1378481419, 1378481419),
(33, 1, '', 'twertwertwer', 'aergwergwe', 'rodeyluo@gmail.com', 'rwer', 'rodeyluo@gmail.com', 0, 1, 1378481424, 1378481424),
(34, 1, '', 'rttert', 'trertye', 'rodeyluo@gmail.com', 'erty', 'ertyer', 0, 1, 1378481429, 1378481429),
(35, 1, '', 'ertyertyertyert', 'ter', 'rodeyluo@gmail.com', 'yety', 'erty', 0, 1, 1378481433, 1378481433),
(36, 1, '', 'fasdfas', 'asfasf', 'rodeyluo@gmail.com', 'dfasf', 'asfas', 0, 1, 1378555849, 1378555849),
(37, 1, '', 'E途商城维护', '罗勇', 'info@szhff.com', '13723722479', '香港华锋实业有限公司', 0, 1, 1378555935, 1378555935),
(38, 1, '', '期待合作 -> 提交您的需求给我们，我们会以最快速度回复您！', 'LuoYong', '453474593@qq.com', '13723722479', '盛艺设计', 0, 1, 1378556923, 1378556923),
(39, 1, '', '做一个官方网站需要多少费用？另外还需要准备什么资料呢？', '李海燕', 'rodeyluo@gmail.com', '15813704141', '蓝海之燕', 1, 1, 1378564281, 1378564450),
(41, 1, '', '来淘商城请帮忙修改一下！', '陶捍东', 'nowtao@qq.com', '13723722479', '来淘商贸', 0, 1, 1378909612, 1378909612),
(42, 1, '', '有需要做一个企业官方网站', '胡开', 'hukai@gmail.com', '13723722479', '胡开科技', 0, 1, 1378910010, 1378910010),
(43, 1, '', '测试', 'Luoyong', 'rodeyluo@126.com', '13723722479', 'SYSTacm', 0, 1, 1378911903, 1378911903),
(44, 1, '', '期待合作', '李海燕', 'lihaiyan@qq.com', '15813704141', '燕子', 0, 1, 1378912813, 1378912813),
(45, 1, '', 'DDO  ODOD', 'OPO', 'opo@cc.com', '13723722479', 'OPO CTO', 1, 1, 1378912984, 1378980067),
(46, 1, '', 'asdfasdf', 'dfasfasf', 'sdfasdfas@qqq.com', '13723722479', 'sadf', 0, 1, 1378913186, 1378913186),
(47, 1, '', 'asfas', 'asdfas', 'sdfa@qwwed.com', '13723722479', 'asf', 0, 1, 1378913586, 1378913586),
(48, 1, '', 'asdfasdf', 'asdfasf', 'asdfasdfas@qq.com', '13723722479', 'asf', 0, 1, 1378913732, 1378913732),
(49, 1, '', 'sdfasdf', 'fasfasdf', 'safasf@qq.com', '15817343910', 'asf', 1, 1, 1378913946, 1378979886),
(51, 1, '', '做一个手机产品Flash专题页面', '华为', 'huawei@gmail.com', '13723722479', '华为通信科技', 1, 1, 1378980079, 1378980746),
(52, 1, '', 'sdfasdfasdf', 'dfasdfasdf', 'dfasdf@qwdwe.com', '13723722479', 'sadfa', 0, 1, 1378984605, 1378984605),
(53, 1, '', 'sdfasdfasdf', 'dfasdfasdf', 'dfasdf@qwdwe.com', '13723722479', 'sadfa', 0, 1, 1378984682, 1378984682),
(54, 1, '', 'sdfasdfasdf', 'dfasdfasdf', 'dfasdf@qwdwe.com', '13723722479', 'sadfa', 0, 1, 1378984782, 1378984782),
(55, 1, '', 'sdfasdfasdf', 'dfasdfasdf', 'dfasdf@qwdwe.com', '13723722479', 'sadfa', 0, 1, 1378984931, 1378984931),
(56, 1, '', 'sdfasdfasdf', 'dfasdfasdf', 'dfasdf@qwdwe.com', '13723722479', 'sadfa', 0, 1, 1378984976, 1378984976),
(57, 1, '', '做一个路由器产品专题页面', '华为', 'admin@huawei.com', '13723722479', '华为通信科技', 0, 1, 1378985107, 1378985107),
(58, 1, '', '做官网', '罗勇', 'rodeyluo@gmail.com', '15817343910', '盛艺设计工作室', 0, 1, 1378987150, 1378987150),
(59, 1, '', '部署10台Linux WEB 服务器', '罗子艺', '453474593@qq.com', '13723722479', '盛艺集团', 0, 1, 1378988410, 1378988410),
(60, 1, '', 'asdfasdfasd', 'asdfasdfasd', 'fasdfas@qq.com', 'sdfasdfasd', 'fasdf', 0, 1, 1378988479, 1378988479);

-- --------------------------------------------------------

--
-- 表的结构 `syst_guestbook_reply`
--

CREATE TABLE IF NOT EXISTS `syst_guestbook_reply` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='留言恢复信息表' AUTO_INCREMENT=30 ;

--
-- 转存表中的数据 `syst_guestbook_reply`
--

INSERT INTO `syst_guestbook_reply` (`id`, `gid`, `uname`, `content`, `disabled`, `add_time`) VALUES
(8, 4, 'rodey(管理员)', '回复内容', 1, 1378468371),
(7, 4, 'rodey(管理员)', '回复内容', 1, 1378468339),
(6, 4, 'rodey(管理员)', '回复内容', 1, 1378468234),
(9, 4, 'rodey(管理员)', '回复内容', 1, 1378468418),
(10, 4, 'rodey(管理员)', '回复内容', 1, 1378468458),
(11, 4, 'rodey(管理员)', '回复内容', 1, 1378468584),
(12, 1, 'rodey(管理员)', '回复内容', 1, 1378468692),
(13, 4, 'rodey(管理员)', '来看啊', 1, 1378474767),
(20, 39, 'rodey(管理员)', '您好！做一个通用版本的官方网站需要5000元，你需要准备域名和空间，如果没有准备，我们也提供的业务！', 1, 1378564414),
(21, 39, 'rodey(管理员)', '哦，好的，我们先准备域名和空间', 1, 1378564450),
(22, 1, 'rodey(管理员)', '98拳皇好玩哦! 我喜欢玩的', 1, 1378668026),
(23, 1, 'rodey(管理员)', '回复内容2', 1, 1378668061),
(27, 45, 'rodey(管理员)', '回复内容OPO----OPO', 1, 1378980067),
(26, 49, 'rodey(管理员)', '回复内容', 1, 1378979886),
(28, 51, 'rodey(管理员)', '回复内容----华为', 1, 1378980100),
(29, 51, 'rodey(管理员)', '我们会先列举几个方案以供选择的', 1, 1378980746);

-- --------------------------------------------------------

--
-- 表的结构 `syst_guestbook_type`
--

CREATE TABLE IF NOT EXISTS `syst_guestbook_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '留言类型自动编号',
  `name` varchar(30) NOT NULL COMMENT '留言类型名称',
  `add_time` int(30) NOT NULL COMMENT '添加时间',
  `update_time` int(30) NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='留言类型信息表' AUTO_INCREMENT=2 ;

--
-- 转存表中的数据 `syst_guestbook_type`
--

INSERT INTO `syst_guestbook_type` (`id`, `name`, `add_time`, `update_time`) VALUES
(1, '网站开发需求', 0, 0);
...
CREATE TABLE IF NOT EXISTS `syst_ipbans` (
  ...
  `add_time` int(30) unsigned NOT NULL COMMENT '禁止时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='IP管理信息表' AUTO_INCREMENT=38 ;

--
-- 转存表中的数据 `syst_ipbans`
--

INSERT INTO `syst_ipbans` (`id`, `ip_addr`, `reason`, `eunlock_time`, `add_time`) VALUES
(1, '113.105.157.52', '多次测试后台的登录', 0, 0),
(14, '121.113.21.12', '多次发送一些不健康信息', 0, 1378751843),
(35, '113.105.157.112', '暴力SQL注入攻击', 1388429700, 1378753216),
(36, '\n113.105.157.522', '暴力SQL注入攻击', 1388429700, 1378753216),
(37, '\n113.105.157.55', '暴力SQL注入攻击', 1388429700, 1378753216);
...
CREATE TABLE IF NOT EXISTS `syst_log` (
  ...
  `add_time` int(20) unsigned NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统日志信息表' AUTO_INCREMENT=116 ;
...
(115, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1379161839),
(114, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1379107251),
(113, '短信群发管理', '删除短信', '删除成功！', 1, '', '127.0.0.1', 2, 1378988534),
(112, '邮件管理', '删除邮件', '删除成功！', 1, '', '127.0.0.1', 2, 1378988523),
(111, '邮件订阅', '发送邮件', '发送成功！', 1, '', '127.0.0.1', 2, 1378988184),
(109, '短信群发管理', '删除短信', '删除成功！', 1, '', '127.0.0.1', 2, 1378985009),
(110, '短信群发管理', '删除短信', '删除成功！', 1, '', '127.0.0.1', 2, 1378985013),
(108, '短信群发管理', '删除短信', '删除成功！', 1, '', '127.0.0.1', 2, 1378983047),
(107, '邮件管理', '删除邮件', '删除成功！', 1, '', '127.0.0.1', 2, 1378982839),
(106, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378979234),
(105, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378912088),
(104, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378912062),
(66, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378665141),
(67, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378675786),
(68, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378675818),
(69, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378715826),
(70, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378725840),
(71, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378726592),
(72, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378726641),
(73, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378727093),
(74, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378727193),
(75, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378727283),
(76, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378727466),
(77, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378728402),
(78, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378728567),
(79, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378728682),
(80, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378728684),
(81, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378728751),
(82, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378730749),
(83, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378730874),
(84, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378730915),
(85, '数据库', '备份数据库', '删除备份数据库成功', 2, '', '127.0.0.1', 2, 1378732144),
(86, '数据库', '备份数据库', '删除备份数据库成功', 2, '', '127.0.0.1', 2, 1378732278),
(87, '数据库', '备份数据库', '删除备份数据库成功', 2, '', '127.0.0.1', 2, 1378732307),
(88, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378732388),
(89, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378732553),
(90, '数据库', '备份数据库', '备份数据库成功', 2, '', '127.0.0.1', 2, 1378732596),
(91, '数据库', '运行SQL命令行', '完成', 2, '', '127.0.0.1', 2, 1378732675),
(92, '数据库', '运行SQL命令行', '完成', 2, '', '127.0.0.1', 2, 1378732922),
(93, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378744652),
(94, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378780783),
(95, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378780903),
(96, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378817928),
(97, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378875886),
(98, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378880857),
(99, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378880870),
(100, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378893927),
(101, '邮件订阅', '发送邮件', '发送成功', 1, '', '127.0.0.1', 2, 1378904927),
(102, '病毒扫描', '扫描病毒', '扫描成功！', 0, '', '127.0.0.1', 2, 1378905295),
(103, '病毒扫描', '扫描病毒', '扫描成功！', 2, '', '127.0.0.1', 2, 1378905356);
...
(2, '地方斯蒂芬', '<p>对斯蒂芬啊是发放</p>', 'rodey', 0, 1363948375, 1364293800, 1372448027, 1372448027);
...
CREATE TABLE IF NOT EXISTS `syst_region` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='地区信息表' AUTO_INCREMENT=3409 ;

--
-- 转存表中的数据 `syst_region`
--

INSERT INTO `syst_region` (`region_id`, `parent_id`, `region_name`, `region_type`, `agency_id`) VALUES
(1, 0, '中国', 0, 0),
(2, 1, '北京', 1, 0),
(3, 1, '安徽', 1, 0),
(4, 1, '福建', 1, 0),
...
CREATE TABLE IF NOT EXISTS `syst_resnet` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  ...
  `update_time` int(30) unsigned NOT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='服务网络信息表' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `syst_resnet`
--

INSERT INTO `syst_resnet` (`id`, `net_tid`, `net_name`, `net_address`, `net_hotline`, `net_u_name`, `net_u_phone`, `net_mapx`, `net_mapy`, `net_mapz`, `net_region`, `net_pic`, `net_msg`, `disabled`, `author`, `add_time`, `update_time`) VALUES
(1, 1, '香港华锋实业有限公司', '深圳市南山区科技园南区德赛科技大厦10楼', '0755-68089456', '孙金华', '13631634475', '11395448', '2253934', '0', 6, '', '<p>请编写内容！</p>', 1, 'rodey', 1367629674, 1367629674),
(2, 1, '北京顺通天下商贸有限公司 版权所有', '北京市丰台区西三环丰益桥西国贸汽配基地A1-2062', '0755-68089456', '李锋刚', '', '11631446', '3985562', '0', 2, '', '', 1, 'rodey', 1367630008, 1367630008),
(3, 1, '盛网科技', '深圳市南山区科技园南区德赛科技大厦10楼', '0755-21671712', '罗勇', '13723722479', '11395455', '2253937', '1', 6, 'http://systacm.com/uploadfile/slider/1364572800/banner_13645728001800.jpg', '<p>深圳市盛艺网络科技有限公司</p>', 1, 'rodey', 1367639873, 1367639873);

-- --------------------------------------------------------

--
-- 表的结构 `syst_resnettype`
--

CREATE TABLE IF NOT EXISTS `syst_resnettype` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '自动编码',
  `name` char(50) NOT NULL COMMENT '服务网点类型名称',
  `add_time` int(30) unsigned NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='服务网点类型信息表' AUTO_INCREMENT=29 ;

--
-- 转存表中的数据 `syst_resnettype`
--

INSERT INTO `syst_resnettype` (`id`, `name`, `add_time`) VALUES
(1, '总代理商', 1367614469),
(2, '一级代理', 1367614469),
(3, '二级代理', 1367614469),
(4, '三级代理', 1367614469),
...
(14, '焦点图管理', '7', 'banner', 'c,u,r,d', 0, 1378396599);
...
CREATE TABLE IF NOT EXISTS `syst_sms` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='短消息信息表' AUTO_INCREMENT=75 ;

--
-- 转存表中的数据 `syst_sms`
--

INSERT INTO `syst_sms` (`id`, `type_id`, `from_id`, `to_id`, `title`, `content`, `type`, `add_time`) VALUES
(2, 1, 2, 35, 'dfgsdfg', 'dfgsdfgsdfgsdfgsdf', 1, 0),
(3, 1, 2, 69, '呃呃呃', 'adfadsfasdfasdf', 1, 1365528307),
(4, 2, 2, 68, '是的发生地方', '阿斯多夫阿斯多夫', 1, 1365535344),
(6, 3, 2, 15, '啊的说法是地方', '阿斯多夫啊', 1, 1365536067),
(7, 4, 2, 67, '阿萨德发放', '规范的规范化东莞', 1, 0),
(10, 5, 2, 67, '的发丝得法', '阿斯顿法', 1, 0),
(54, 1, 2, 15, '盛艺ACM系统（SYSTacm）', '开源ACM系统 盛艺ACM（SYSTacm）系统今天发布了！', 1, 1372514642),
(55, 1, 2, 33, '盛艺ACM系统（SYSTacm）', '开源ACM系统 盛艺ACM（SYSTacm）系统今天发布了！', 1, 1372514642),
(49, 1, 2, 2, 'sdasdf', 'asdfasdfasd', 2, 1365609291),
(56, 3, 2, 2, '送积分了', '凡新手上路会员都将免费获得20积分，请查看自己的积分数，如有问题请联系客服！', 2, 1372515138),
(74, 3, 2, 15, '后台充值', '后台送20积分，请你到系统个人中心查看！', 1, 1372533105),
(73, 3, 2, 2, '后台充值', '后台送20积分，请你到系统个人中心查看！', 1, 1372533105);
...
CREATE TABLE IF NOT EXISTS `syst_sms_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  ...
  `add_time` int(20) NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='消息类型信息表' AUTO_INCREMENT=9 ;

--
-- 转存表中的数据 `syst_sms_type`
--

INSERT INTO `syst_sms_type` (`id`, `name`, `icon`, `sms_count`, `disabled`, `add_time`) VALUES
(1, '通知', '', 4, 0, 1372517808),
(2, '警告', '', 1, 0, 1372512594),
(3, '加积分', '', 1, 0, 1372512650),
(4, '加金额', '', 1, 0, 1372512667),
(5, '送礼', '', 1, 0, 1372513076),
(7, '发奖品', '', 0, 0, 1372518921),
(8, '直线', '', 0, 1, 1372520855);
...
CREATE TABLE IF NOT EXISTS `syst_subemail` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT COMMENT '自动编号',
  `name` varchar(200) NOT NULL COMMENT '名称',
  `email` varchar(100) NOT NULL COMMENT '邮箱地址',
  `disabled` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '是否订阅',
  `add_time` int(30) unsigned NOT NULL COMMENT '订阅时间',
  `un_time` int(30) unsigned NOT NULL COMMENT '取消订阅时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='邮件订阅信息表' AUTO_INCREMENT=24 ;

--
-- 转存表中的数据 `syst_subemail`
--

INSERT INTO `syst_subemail` (`id`, `name`, `email`, `disabled`, `add_time`, `un_time`) VALUES
(1, 'Rodey', 'rodeyluo@gmail.com', 1, 1378753216, 1388429700),
(2, 'LuoYong', 'luoyong19871112@163.com', 1, 1378753216, 1388429700),
(8, 'Luoyong', 'rodeyluo@126.com', 1, 1378911903, 1441983903),
(7, '胡开', 'hukai@gmail.com', 0, 1378910010, 1441982010),
(9, '李海燕', 'lihaiyan@qq.com', 1, 1378912813, 1441984813),
(20, '华为', 'admin@huawei.com', 1, 1378985107, 1442057107),
(21, '罗勇', 'rodeyluo@gmail.com', 1, 1378987150, 1442059151),
(22, '罗子艺', '453474593@qq.com', 1, 1378988410, 1442060410);
...
CREATE TABLE IF NOT EXISTS `syst_subphone` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) NOT NULL,
  `phone` varchar(30) NOT NULL,
  `disabled` tinyint(1) unsigned NOT NULL DEFAULT '1',
  `add_time` int(30) unsigned NOT NULL,
  `un_time` int(30) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='手机号码信息表' AUTO_INCREMENT=12 ;

--
-- 转存表中的数据 `syst_subphone`
--

INSERT INTO `syst_subphone` (`id`, `name`, `phone`, `disabled`, `add_time`, `un_time`) VALUES
(8, '华为', '13723722479', 1, 1378985107, 1442057107),
(9, '罗勇', '15817343910', 1, 1378987150, 1442059151),
(10, '罗子艺', '13723722479', 1, 1378988410, 1442060410);
...
CREATE TABLE IF NOT EXISTS `syst_user` (
  ...
  `gold` int(8) NOT NULL DEFAULT '0' COMMENT '金币数',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='用户会员信息表' AUTO_INCREMENT=72 ;

--
-- 转存表中的数据 `syst_user`
--

INSERT INTO `syst_user` (`id`, `name`, `pass`, `email`, `nick_name`, `true_name`, `sex`, `birthday`, `address`, `phone`, `tel`, `intro`, `signa`, `headport`, `user_group`, `point`, `money`, `gold`, `activate`, `token`, `ip`, `level`, `disabled`, `reg_time`, `last_login_time`, `last_login_ip`, `update_time`) VALUES
(2, 'rodey', '5aa26937a3b0a86999868d8b28508aee', 'rodeyluo@gmail.com', '天蝎飞碟', '罗勇', 1, 1361980800, '深圳市罗湖区泥岗西村', '13723722479', '0755-21671712', '来自江西吉安盘谷镇坛山园村5566', '像风一样自由！', 'uploadfile/users/headport/100/user_13724352004357.png', 5, 1303, '1552.00', 0, 0, '0', '127.0.0.1', 4, 1, 1362044903, 1379161839, '127.0.0.1', 1379161839),
(37, 'Luo1', '92faf1e066218c71c780ea2240d17bec', 'looyoohoo@gmail.com', '蓝海之燕', '李海燕', 2, 687369600, '深圳市罗湖区泥岗西村5栋701室', '13723722479', '0755-21671712', '来自江西吉安盘谷镇官家村', '像风一样自由！', NULL, 1, 5000, '375.08', 0, 0, '0', NULL, 4, 0, NULL, NULL, '', 1372532907),
(33, 'Luo2', 'c78b6663d47cfbdb4d65ea51c104044e', 'luoy@szhff.com', '子艺书怀', '罗子艺', 1, 1363276800, '深圳市罗湖区泥岗西村', '13723722479', '0755-21671712', '', '', NULL, 1, 400, '72.08', 0, 0, '0', NULL, 4, 1, NULL, NULL, '', 1372532907),
(36, 'Luo3', '0144712dd81be0c3d9724f5e56ce6685', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'uploadfile/users/headport/100/user_13633632007237.gif', 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(34, 'Luo4', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'uploadfile/users/headport/100/user_13633632009725.gif', 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(35, 'Luo5', '0144712dd81be0c3d9724f5e56ce6685', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'uploadfile/users/headport/100/user_13633632003420.png', 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', 1372445299),
(30, 'LiHY1', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, 'uploadfile/users/headport/100/user_13633632006818.gif', 1, 0, '0.00', 0, 0, '0', NULL, 0, 0, NULL, NULL, '', NULL),
(27, 'LiHY2', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(13, 'rodey1', '1b08a4fe8ab0b8cb04b676f892964375', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(15, 'LuoYong', '723fe959c3e96e188c4d613842d6f918', '453474593@qq.com', '蓝海之燕', '', 0, 1363276800, '', '13723722479', '', '', '', 'uploadfile/users/headport/100/user_13633632006024.png', 1, 168, '300.05', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', 1372533105),
(16, 'rodey3', '1b08a4fe8ab0b8cb04b676f892964375', 'soo_oo@yahoo.cn', '', '', 0, 25, NULL, NULL, NULL, NULL, NULL, NULL, 1, 100, '200.05', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', 1372503827),
(21, 'rodey4', '828972916', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(22, 'rodey5', '828972916', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(23, 'rodey6', '828972916', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(24, 'rodey7', '828972916', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(25, 'rodey8', '828972916', 'soo_oo@yahoo.cn', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(38, 'Luo6', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(39, 'Luo7', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(40, 'Luo8', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(41, 'Luo9', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(42, 'Luo10', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(43, 'Yong', '438955454', '84dfasdf@gmail.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(44, 'Luo11', '098765', '90809df@qq.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(45, 'Yong1', '438955454', '84dfasdf@gmail.com', '', '', 0, 25, NULL, '12723722479', NULL, 'My name is Rodey!', NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(49, '李海燕', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(48, '李海燕1', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(50, '李海燕2', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(51, '李海燕3', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(52, '李海燕4', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(53, '李海燕5', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(54, '李海燕6', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(55, '李海燕7', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(56, '李海燕8', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(57, '李海燕9', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(60, '李海燕10', '123456', 'li@3434.com', '', '', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0, '0.00', 0, 0, '0', NULL, 0, 1, NULL, NULL, '', NULL),
(68, '香港华锋', 'd8406e8445cc99a16ab984cc28f6931615c766fc', 'info@szhff.com', '香港华锋', '香港华锋', 1, -28800, '深圳市南山区科技园德赛科技大厦', '13723722479', '0755-21671712', '香港华锋实业有限公司', 'GPS品牌', 'uploadfile/users/headport/100/user_13633632006735.gif', 1, 0, '36.08', 0, 0, '', '127.0.0.1', 4, 1, 1363247924, NULL, '', 1372538110),
(69, 'e途商城', 'd8406e8445cc99a16ab984cc28f6931615c766fc', 'rodey@etu100.com', 'e途商城', 'e途商城', 2, 2013, '深圳市南山区科技园德赛科技大厦', '13723722479', '0755-21671712', 'e途商城', 'e途商城', NULL, 1, 0, '24.08', 0, 0, '', '127.0.0.1', 4, 1, 1363248622, NULL, '', 1372531263),
(71, 'SYSTacm', '68b86699d948788eed191c8ea622c175a91fda92', 'rodeyluo@gmail.com', '盛艺', '盛艺', 0, 1987, '深圳市罗湖区泥岗西村', '13723722479', '0755-21671712', '开源的ACM系统', '像风一样自由！', 'uploadfile/users/headport/100/user_13725216009514.png', 11, 1000000, '999999.99', 0, 0, '', '127.0.0.1', 4, 1, 1372535615, NULL, '', 1372535615);
...
CREATE TABLE IF NOT EXISTS `syst_user_group` (
  ...
  `gold` int(8) NOT NULL DEFAULT '0' COMMENT '金币数量',
...
INSERT INTO `syst_user_group` (`id`, `name`, `value`, `point`, `gold`, `sort`, `icon`, `disabled`, `add_time`) VALUES
(2, '新手上路', 1, 20, 0, 0, '', 1, 1372534330),
(3, '初级会员', 2, 50, 0, 0, '', 1, 1372534330),
(4, '中级会员', 3, 100, 0, 0, '', 1, 1372534330),
(5, '高级会员', 4, 150, 0, 0, '', 1, 1372534330),
(7, '手机认证', 6, 150, 0, 0, '', 1, 1372534330),
(8, '社区绑定', 7, 150, 0, 0, '', 1, 1372534330),
(9, '禁止访问', 0, -100, 0, 0, '', 0, 1372534330),
(10, '天外飞仙', 8, 2000, 0, 0, '', 1, 1372534341),
(11, '仁者无敌', 9, 1000, 0, 0, '', 1, 1372534351);
