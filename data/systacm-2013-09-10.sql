...
CREATE TABLE IF NOT EXISTS `syst_guestbook` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='留言信息表' AUTO_INCREMENT=41 ;
...
CREATE TABLE IF NOT EXISTS `syst_guestbook_reply` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='留言恢复信息表' AUTO_INCREMENT=24 ;
...
CREATE TABLE IF NOT EXISTS `syst_log` (
  ...
  `add_time` int(20) unsigned NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='系统日志信息表' AUTO_INCREMENT=94 ;
...
(1, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1372449926),
(2, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1372494778),
(3, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1372499957),
(4, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1372499973),
(5, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1372567100),
(6, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1372595336),
(7, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1372595356),
(8, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1372595411),
(9, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1372595428),
(10, '系统配置', '生成配置文件', '生成配置文件成功', 2, '', '127.0.0.1', 2, 1372609874),
(11, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1372691867),
(12, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1373459769),
(13, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1373465664),
(14, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1373465687),
(15, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1373547903),
(16, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1375541753),
(17, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1375713926),
(18, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1375714748),
(19, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1375714775),
(20, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1376232511),
(21, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1377093965),
(22, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1377094153),
(23, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1377342867),
(24, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1377843792),
(25, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378095634),
(26, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378111077),
(27, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378117628),
(28, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378228180),
(29, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378309973),
(30, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378310184),
(31, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378362586),
(32, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378362599),
(33, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378364876),
(34, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378368641),
(35, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378368659),
(36, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378369148),
(37, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 2, 1378371576),
(38, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378371619),
(39, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378371643),
(40, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378372211),
(41, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378372347),
(42, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378372352),
(43, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378372392),
(44, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378373469),
(45, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378373478),
(46, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378373481),
(47, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378375722),
(48, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378375727),
(49, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378378256),
(50, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378378259),
(51, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378381738),
(52, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378390481),
(53, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378390503),
(54, '后台登录', '退出', '退出成功！', 1, '', '127.0.0.1', 2, 1378390587),
(55, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378390739),
(56, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378390746),
(57, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378391234),
(58, '后台登录', '登录', '登录失败！', 0, '', '127.0.0.1', 0, 1378391257),
(59, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378391264),
(60, '系统配置', '生成配置文件', '生成配置文件成功', 2, '', '127.0.0.1', 2, 1378394550),
(61, '系统配置', '生成配置文件', '生成配置文件成功', 2, '', '127.0.0.1', 2, 1378394648),
(62, '系统配置', '生成配置文件', '生成配置文件成功', 2, '', '127.0.0.1', 2, 1378396102),
(63, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378463082),
(64, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378555456),
(65, '后台登录', '登录', '登录成功！', 1, '', '127.0.0.1', 2, 1378644885),
...
CREATE TABLE IF NOT EXISTS `syst_subemail` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='邮件订阅信息表' AUTO_INCREMENT=4 ;
...
(2, 'rodey', '5aa26937a3b0a86999868d8b28508aee', 'rodeyluo@gmail.com', '天蝎飞碟', '罗勇', 1, 1361980800, '深圳市罗湖区泥岗西村', '13723722479', '0755-21671712', '来自江西吉安盘谷镇坛山园村5566', '像风一样自由！', 'uploadfile/users/headport/100/user_13724352004357.png', 5, 1263, '1552.00', 0, '0', '127.0.0.1', 4, 1, 1362044903, 1378744652, '127.0.0.1', 1378744652),
