...
CREATE TABLE `syst_log` (
  ...
  `add_time` int(20) unsigned NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COMMENT='系统日志信息表';
...
INSERT INTO `Array` VALUES('84','数据库','备份数据库','备份数据库成功','2','','127.0.0.1','2','1378730915');
INSERT INTO `Array` VALUES('85','数据库','备份数据库','删除备份数据库成功','2','','127.0.0.1','2','1378732144');
INSERT INTO `Array` VALUES('86','数据库','备份数据库','删除备份数据库成功','2','','127.0.0.1','2','1378732278');
INSERT INTO `Array` VALUES('87','数据库','备份数据库','删除备份数据库成功','2','','127.0.0.1','2','1378732307');
INSERT INTO `Array` VALUES('88','数据库','备份数据库','备份数据库成功','2','','127.0.0.1','2','1378732388');
INSERT INTO `Array` VALUES('89','数据库','备份数据库','备份数据库成功','2','','127.0.0.1','2','1378732553');
INSERT INTO `` VALUES();
