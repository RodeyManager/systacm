...
class tree {
	...
	* @param array 2维数组，例如：
	* array(
	*      1 => array('id'=>'1','pid'=>0,'cat_name'=>'一级栏目一'),
	*      2 => array('id'=>'2','pid'=>0,'cat_name'=>'一级栏目二'),
	*      3 => array('id'=>'3','pid'=>1,'cat_name'=>'二级栏目一'),
	*      4 => array('id'=>'4','pid'=>1,'cat_name'=>'二级栏目二'),
	*      5 => array('id'=>'5','pid'=>2,'cat_name'=>'二级栏目三'),
	*      6 => array('id'=>'6','pid'=>3,'cat_name'=>'三级栏目一'),
	*      7 => array('id'=>'7','pid'=>3,'cat_name'=>'三级栏目二')
	*      )
	*/
	...
	*/
	...
	public function creat_sub_json($myid, $str='') {
		...
		if(is_array($sub_cats)) foreach($sub_cats as $c) {			
			$data[$n]['id'] = iconv(CHARSET,'utf-8',$c['id']);
			if($this->get_child($c['id'])) {
				$data[$n]['liclass'] = 'hasChildren';
				$data[$n]['children'] = array(array('text'=>'&nbsp;','classes'=>'placeholder'));
				$data[$n]['classes'] = 'folder';
				$data[$n]['text'] = iconv(CHARSET,'utf-8',$c['cat_name']);
			} else {				
				if($str) {
